...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { test_int: @test.test_int, test_string: @test.test_string } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { test_int: @test.test_int, test_string: @test.test_string } }
