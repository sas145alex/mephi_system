...
class DirectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create direction" do
    assert_difference('Direction.count') do
      post directions_url, params: { direction: { finish_date: @direction.finish_date, name: @direction.name, nominated_date_end: @direction.nominated_date_end, receive_date: @direction.receive_date, status: @direction.status } }
    end
  ...
  test "should update direction" do
    patch direction_url(@direction), params: { direction: { finish_date: @direction.finish_date, name: @direction.name, nominated_date_end: @direction.nominated_date_end, receive_date: @direction.receive_date, status: @direction.status } }
